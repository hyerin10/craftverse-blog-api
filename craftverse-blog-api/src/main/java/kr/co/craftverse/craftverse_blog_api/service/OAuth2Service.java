...
public class OAuth2Service {
   ...
   * 구글 로그인 URL을 생성합니다.
   */
  public String getGoogleAuthUrl(HttpServletRequest request) {
   ...
   */
  @Transactional
  public String processGoogleCallback(String code, HttpServletRequest request, HttpServletResponse response) throws Exception {
    // 구글에서 액세스 토큰 얻기
    ...
    // cookie.setSecure(true); // HTTPS에서만 사용하려면 활성화
    cookie.setMaxAge((int) (tokenExpirationMs / 1000));
